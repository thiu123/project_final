<template>
  <v-app-bar class="bg-waterblue elevation-2" height="100">
    <v-container
    ...
    >
      ...
      >
        <nuxt-link to="/" class="d-flex align-center text-decoration-none">
          <v-avatar
            size="48"
            class="mr-3 bg-customyellow logo-avatar elevation-4"
          >
          ...
          <span
            class="font-weight-bold text-h5 text-white letter-spacing logo-text"
            >THBookStore</span
          >
        </nuxt-link>
      </div>
          ...
          <template v-if="isSessionRestored" v-slot:activator="{ props }">
            <template v-if="!currentUser">
              <v-btn
                color="customyellow"
                variant="flat"
                class="ml-2 font-weight-bold text-darkgreen text-subtitle-1 account-btn"
                rounded="pill"
                v-bind="props"
              ...
              >
                Account
                <v-icon class="ml-1" size="22">mdi-account-circle</v-icon>
              </v-btn>
            </template>
            ...
            <template v-else>
              ...
              >
                <div class="d-flex align-center">
                  ...
                  <v-icon size="20" class="ml-1">mdi-chevron-down</v-icon>
                </div>
              </v-btn>
            </template>
          </template>
      ...
      >
        <div class="position-relative">
          <Login @toggleLinkSignUp="openDialog" @show-snackbar="showSnackbar" />
          <v-btn
            icon
...
export default {
  ...
  computed: {
    ...
    ...mapState("cart", ["cart"]),
    userFavoritesCount() {
      return this.favorites.items ? this.favorites.items.length : 0;
    },
    cartItemCount() {
