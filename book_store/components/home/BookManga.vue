  ...
  <section class="mx-auto mt-12 w-full max-w-[1500px] px-4">
    ...
    <div class="mb-8 flex items-center justify-between">
      <div class="flex items-center">
        ...
        >
          <BookOpen class="h-8 w-8 text-darkgreen dark:text-foreground" />
        </div>
        <div>
          <h2
    ...
    <div v-else class="relative">
      ...
      <Swiper
        ...
        :loop="true"
        :breakpoints="swiperBreakpoints"
        class="manga-swiper px-1 pb-[50px]"
        @swiper="onSwiper"
      >
        <SwiperSlide v-for="(book, i) in mangaBooks" :key="i">
          <div
          ...
          >
            ...
            <div class="relative flex items-center justify-center p-5">
              <div
                class="aspect-[2/3] w-[70%] max-w-[180px] overflow-hidden bg-muted transition-all duration-[400ms] ease-in-out group-hover:-translate-y-2 group-hover:scale-105 group-hover:shadow-[0_16px_40px_rgba(0,0,0,0.25)]"
              >
                <img
                  :src="book?.cover_url"
                  :alt="book.title"
              ...
              <!-- Manga Badge -->
              <span
                class="absolute bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-gradient-to-br from-[#ffd700] to-[#ffed4e] px-2 py-0.5 text-[10px] font-semibold tracking-[0.5px] text-[#2c3e50]"
              >
                Manga
              </span>
            </div>
...
const mangaBooks = computed<Book[]>(() => homeSubjects.value["manga"] || []);
