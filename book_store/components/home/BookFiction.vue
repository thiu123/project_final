  ...
  <v-container max-width="1500" class="mt-12">
    ...
    <div class="d-flex justify-space-between align-center mb-8">
      <div class="d-flex align-center">
        <div class="category-icon-wrapper mr-4">
          <v-icon size="32" color="darkgreen"
    ...
    <div v-else class="swiper-container-wrapper">
      ...
      <swiper
        ...
        class="fiction-swiper"
      >
        <swiper-slide v-for="(book, i) in fictionBooks" :key="i">
          <v-hover v-slot="{ isHovering, props }">
            <v-sheet
              v-bind="props"
...
export default {
  ...
  slideNext() {
    this.$refs.fictionSwiper.$el.swiper.slideNext();
  },
};
</script>
