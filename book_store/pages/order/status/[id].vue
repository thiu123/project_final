      ...
      <v-col cols="12" md="10" lg="8">
        ...
        <v-card class="mb-6" elevation="2" rounded="lg" v-if="order">
          <v-card-title class="d-flex align-center pa-5 bg-grey-lighten-5">
            <v-icon icon="mdi-receipt-text" class="mr-3" color="primary" size="28"></v-icon>
          ...
          <v-card-text class="pa-6">
            <v-row dense>
              <v-col cols="12" sm="6" md="4">
                <v-card class="pa-4 bg-blue-lighten-5" elevation="0" rounded="lg">
                  <div class="text-caption text-blue-darken-2 mb-1 font-weight-medium">
                    Order ID
                  </div>
              ...
              <v-col cols="12" sm="6" md="4">
                <v-card class="pa-4 bg-purple-lighten-5" elevation="0" rounded="lg">
                  <div class="text-caption text-purple-darken-2 mb-1 font-weight-medium">
                    Order Date
                  </div>
                  <div class="text-subtitle-1 font-weight-bold text-purple-darken-4">
              ...
              <v-col cols="12" sm="6" md="4">
                <v-card class="pa-4 bg-orange-lighten-5" elevation="0" rounded="lg">
                  <div class="text-caption text-orange-darken-2 mb-1 font-weight-medium">
                    Payment Method
                  </div>
              ...
              <v-col cols="12" sm="6" md="4">
                <v-card class="pa-4 bg-green-lighten-5" elevation="0" rounded="lg">
                  <div class="text-caption text-green-darken-2 mb-1 font-weight-medium">
                    Status
                  </div>
                  <v-chip
              ...
              <v-col cols="12" sm="6" md="8">
                <v-card class="pa-4 bg-teal-lighten-5" elevation="0" rounded="lg">
                  <div class="text-caption text-teal-darken-2 mb-1 font-weight-medium">
                    Payment Completed
                  </div>
        ...
        <!-- Items Purchased -->
        <v-card class="mb-6" elevation="2" rounded="lg" v-if="order && order.items">
          <v-card-title class="d-flex align-center pa-5 bg-grey-lighten-5">
            <v-icon icon="mdi-book-multiple" class="mr-3" color="secondary" size="28"></v-icon>
          ...
          <v-list class="pa-0" lines="three">
            <template v-for="(item, index) in order.items" :key="index">
                    ...
                    >
                      <template v-slot:placeholder>
                        <v-row class="fill-height ma-0" align="center" justify="center">
                          <v-icon icon="mdi-book" size="50" color="grey-lighten-2"></v-icon>
                        </v-row>
                      </template>
                    </v-img>
                  </v-card>
                ...
                <div>
                  ...
                  <v-list-item-subtitle>
                    <div class="text-body-2 mb-2 text-grey-darken-1">
                      <v-icon icon="mdi-account-edit" size="16" class="mr-1"></v-icon>
                    ...
                    <v-expansion-panels variant="accordion" class="mt-3">
                      <v-expansion-panel rounded="lg" elevation="0" class="bg-grey-lighten-4">
              ...
              <v-divider v-if="index < order.items.length - 1" class="mx-6"></v-divider>
            </template>
          </v-list>
        </v-card>
        ...
        <v-card class="mb-8" elevation="3" rounded="lg" v-if="order">
          <div class="summary-gradient pa-5">
            <div class="d-flex align-center">
              <v-icon icon="mdi-calculator" class="mr-3" color="white" size="28"></v-icon>
              <span class="text-h5 font-weight-bold text-white">Order Summary</span>
            </div>
          </div>
          ...
          <v-card-text class="pa-6">
            <!-- Items List -->
            <div class="mb-5">
              <div class="text-overline text-grey-darken-2 mb-3 font-weight-bold">
                Items Breakdown
              </div>
              <v-card
            ...
            <div class="d-flex justify-space-between align-center mb-4 px-2">
              <span class="text-body-1 font-weight-medium text-grey-darken-2">Subtotal</span>
            ...
            >
              <div class="d-flex justify-space-between align-center">
                <div>
                  <div class="text-overline text-success-darken-2 mb-1">Total Paid</div>
                  <div class="text-h4 font-weight-bold text-success">
                    {{ order.total.toLocaleString() }} VNĐ
                  </div>
                </div>
                <v-icon icon="mdi-check-circle" size="60" color="success"></v-icon>
              </div>
              
              <!-- USD Equivalent -->
              <div class="text-center mt-4 pt-4" style="border-top: 2px dashed rgba(76, 175, 80, 0.3)">
                <span class="text-body-2 text-success-darken-1 font-weight-medium">
              ...
              <div>
                ...
                <div class="text-body-2 text-blue-darken-2">
                  <div class="mb-2 d-flex align-start">
                    <v-icon icon="mdi-email-check" size="18" class="mr-2 mt-1" color="info"></v-icon>
                    <span>You will receive an email confirmation shortly</span>
                  </div>
                  <div class="mb-2 d-flex align-start">
                    <v-icon icon="mdi-clock-fast" size="18" class="mr-2 mt-1" color="info"></v-icon>
                    <span>Your order will be processed within 1-2 business days</span>
                  </div>
                  <div class="d-flex align-start">
                    <v-icon icon="mdi-map-marker-path" size="18" class="mr-2 mt-1" color="info"></v-icon>
